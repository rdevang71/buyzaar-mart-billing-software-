  ...
  return (
    <MainLayout>
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-5">
        ...
        <Link href="/sales-order/pos" target="_blank" rel="noopener noreferrer" className="self-start flex items-center gap-2 px-4 py-2 border border-blue-300 rounded-lg text-[13px] font-semibold text-blue-600 hover:bg-blue-50 transition-colors flex-shrink-0">
